...
2.  Fork the project on Github,
   ...
   - [https://github.com/BolajiAyodeji/qrcode-builder/fork](https://github.com/BolajiAyodeji/qrcode-builder/fork)
...
3.  Clone the project.
    ...
    ```git
    git clone https://github.com/BolajiAyodeji/qrcode-builder
    ```
